...
export default function SignUp() {
    ...
    let confirmPass = useRef<HTMLInputElement>(null);
    ...
    async function signUpHandler(e: any) {
        ...
        if (email.current && password.current && confirmPass.current) {

            const res = await axios.post("/api/auth/signin", {
                email: email.current.value,
                password: password.current.value,
                confirm:confirmPass.current.value
            })
                        ...
                        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <form onSubmit={signUpHandler} className="space-y-4 md:space-y-6">
                                <div>
                                    ...
                                    <input required={true} ref={email} id="email" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <input ref={confirmPass} id="confirm-password" placeholder="••••••••" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                                </div>
